...
import { CheckboxContainer, HiddenCheckbox, StyledCheckbox, Icon } from "./Checkbox.Style.js";
	...
	render() {
		return (
			<CheckboxContainer className={this.props.className}>
				<HiddenCheckbox checked={this.props.checked} onChange={this.handleCheckChange} />
